    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f3839"), 0, "22222222-2222-2222-2222-222222222222", "contact@mustafaguler.me", true, "Mustafa", "Güler", false, null, "CONTACT@MUSTAFAGULER.ME", "MUSTAFAGULER", "AQAAAAIAAYagAAAAEEk3nJ/T1Enj4Fz9/q2KjX9/q2KjX9/q2KjX9/q2KjX9/q2K==", null, false, "11111111-1111-1111-1111-111111111111", false, "mustafaguler" });
            ...
            migrationBuilder.InsertData(
                table: "Articles",
                columns: new[] { "Id", "CategoryId", "Content", "CreatedDate", "GroupId", "IsDeleted", "LanguageCode", "MainImage", "Slug", "Title", "UpdatedDate", "UserId", "ViewCount" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new Guid("44444444-4444-4444-4444-444444444444"), "Türkçe içerik...", new DateTime(2024, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("99999999-9999-9999-9999-999999999999"), false, "tr", null, "onion-architecture-nedir", "Onion Architecture Nedir?", null, new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f3839"), 100 },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new Guid("44444444-4444-4444-4444-444444444445"), "English content...", new DateTime(2024, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("99999999-9999-9999-9999-999999999999"), false, "en", "/uploads/articles/backend-setup.jpg", "what-is-onion-architecture", "What is Onion Architecture?", null, new Guid("cb94223b-ccb8-4f2f-93d7-0df96a7f3839"), 50 }
                });
