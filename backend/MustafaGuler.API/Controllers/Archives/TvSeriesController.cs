...
{
    [Route("api/archives/tvseries")]
    [ApiController]
    public class TvSeriesController : CustomBaseController
    {
        private readonly ITvSeriesService _service;

        public TvSeriesController(ITvSeriesService service) => _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] CreateTvSeriesDto dto)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateTvSeriesDto dto)
        {
